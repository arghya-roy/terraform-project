...
resource "aws_elastic_beanstalk_environment" "app-prod" {
  ...
  solution_stack_name = "64bit Amazon Linux 2018.03 v2.9.6 running PHP 7.3" # https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html
  
  setting {      # Option settings to configure the new Environment. These override specific values that are set as defaults.
